...
const theme = getLocalStorage('diamond-theme')
// const { collapse } = getLocalStorage('diamond-collapse')
const { language } = getLocalStorage('diamond-language')
...
const mutations = {
    ...
    changeLanguage(state, language) {
        localStorage.setItem('diamond-language', `{"language":"${language}"}`)
